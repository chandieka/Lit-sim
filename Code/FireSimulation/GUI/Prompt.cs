...
namespace FireSimulator
{
	public static class Prompt
	{
		public static (DialogResult DialogResult, string Value) ShowDialog(string message, string title)
		{
			...
			Button confirmation = new Button { Text = "Ok", Left = 270, Width = 100, Top = 90, DialogResult = DialogResult.OK };
			Button cancel = new Button { Text = "Cancel", Left = 23, Width = 100, Top = 90, DialogResult = DialogResult.Cancel };
